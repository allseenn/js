...
Защищенные свойства и методы доступны только внутри объекта (класса) или его наследников (подклассов). Имкна таких свойств должны начинаться с одного символа подчеркивания `_`.
