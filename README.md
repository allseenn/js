...
Конструктор промиса принимает функцию-исполнитель, являющаюся колбэком, вызывается в момент создания промиса. Функция-исполнтиель принимает в качестве аргументов другие два коллбэка::
