...
Когда исключение создано оно выбрасывается останавливая текущую функцию и все другие вызвавшие ее функции **раскручивая стек** (unwinding the stack) до самого основного вызова вниз в стеке вызовов.
Термин **раскручивать** означает, что в момент ошибки программа останавливается, но объект исключения с детальной информацией, проходит назад по цепочке стека. Это позволяет поймать обработать данный объект, на любом из этапов **раскрутки**.
